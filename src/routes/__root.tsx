...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Lynova Digital Solutions helps businesses build a strong digital presence through websites, web applications, branding, logo design, brochure design, portfolio websites and digital marketing services." },
      ...
      { name: "twitter:description", content: "Lynova Digital Solutions helps businesses build a strong digital presence through websites, web applications, branding, logo design, brochure design, portfolio websites and digital marketing services." },
